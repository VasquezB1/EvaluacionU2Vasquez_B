...
a persistence unit "EvaluacionU2Vasquez_BPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/EvaluacionU2Vasquez_B/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "EvaluacionU2Vasquez_B/pom.xml":
...
artifact ("EvaluacionU2Vasquez_B.war") is already built. You can build
